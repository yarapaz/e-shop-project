      ...
      <nav className='products__menu'>
        <ul className='products__list'>
          <li className='products__list--item'>
            ...
            <NavLink className='products__list__link link-light'>
              Ver más
            </NavLink>
          </li>
          <div className='products__box'>
            <li className='products__box__list--item--croptops'>
              ...
              <NavLink className='products__box__link--croptops link-light'>
                Ver más
              </NavLink>
            </li>
            <li className='products__box__list--item--hoodies'>
              ...
              <NavLink className='products__box__link--hoodies link-light'>
                Ver más
              </NavLink>
            </li>
          </div>
